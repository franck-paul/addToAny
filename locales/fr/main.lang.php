...
L10n::$locales['Insert AddToAny sharing tool before content'] = 'Insérer le lien avant le contenu';
L10n::$locales['Insert AddToAny sharing tool after content'] = 'Insérer le lien après le contenu';
L10n::$locales['Advanced options'] = 'Options avancées';
L10n::$locales['AddToAny sharing tool CSS style:'] = 'Style(s) CSS complémentaire à appliquer :';
L10n::$locales['AddToAny sharing tool text prefix:'] = 'Insérer le texte suivant devant le lien de partage :';
L10n::$locales['This will be inserted before link.'] = 'Sera suivi d\'une espace si non vide.';
L10n::$locales['AddToAny sharing tool text suffix:'] = 'Insérer le texte suivant après le lien de partage :';
